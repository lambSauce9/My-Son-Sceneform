...
public class HelloSceneformActivity8 extends AppCompatActivity {
  private static final String TAG = HelloSceneformActivity8.class.getSimpleName();
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    ModelRenderable.builder()
        .setSource(this, R.raw.vishnugarudasana)
        .build()
    ...
    ViewRenderable.builder()
            .setView(this,R.layout.textview8)
            .build()
