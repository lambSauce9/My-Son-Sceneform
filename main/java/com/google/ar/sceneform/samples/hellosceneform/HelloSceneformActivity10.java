...
public class HelloSceneformActivity10 extends AppCompatActivity {
    private static final String TAG = HelloSceneformActivity10.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewRenderable.builder()
                .setView(this, R.layout.textview10)
                .build()
