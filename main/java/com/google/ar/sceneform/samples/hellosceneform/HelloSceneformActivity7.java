...
public class HelloSceneformActivity7 extends AppCompatActivity {
  private static final String TAG = HelloSceneformActivity7.class.getSimpleName();
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    ViewRenderable.builder()
            .setView(this,R.layout.textview7)
            .build()
              ...
              (HitResult hitResult, Plane plane, MotionEvent motionEvent) -> {
                  ...
                  andy.setOnTapListener(new Node.OnTapListener() {
                      ...
                      public void onTap(HitTestResult hitTestResult, MotionEvent motionEvent) {
                          ...
                          text.setParent(andy);
                          text.setLocalPosition(new Vector3(1.2f, 0.10f, 0.10f));
