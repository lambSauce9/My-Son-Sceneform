...
public class HelloSceneformActivity9 extends AppCompatActivity {
    private static final String TAG = HelloSceneformActivity9.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ModelRenderable.builder()
                .setSource(this, R.raw.champalion)
                .build()
